...
class RegisteredDocument extends StatefulWidget {
  ...
  @override
  _RegisteredDocumentState createState() => _RegisteredDocumentState();
}

class _RegisteredDocumentState extends State<RegisteredDocument> {
                      ...
                      label: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text:
                                  ' ${RegisteredDocumentStrings.getString('byNameHint', widget.isToggled)}',
                              style: AppFontStyle2.blinker(
                                color: Color(0xFF36322E),
                                fontSize: 10,
                                fontWeight: FontWeight.w400,
