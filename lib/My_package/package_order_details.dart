...
// import 'package:my_bhulekh_app/My_package/order_package_details.dart';
// import 'package:my_bhulekh_app/controller/order/language controller.dart';
// import 'package:my_bhulekh_app/controller/order/my_order_controller.dart';
...
// import 'package:my_bhulekh_app/investigate_reports_form/rera builder.dart';
...
// import 'package:my_bhulekh_app/old_records_form/old extract1.dart';
...
//         MaterialPageRoute(
//           builder:
//               (context) => OrderpackageDetail(
//                 lead_id: serviceLeadId,
//                 tbl_name: tblName,
//                 order: {
//                   "serviceName":
//                       serviceNameInLocal.isEmpty && isToggled
//                           ? serviceNameInLocal
...
//                           packageData != null
//                               ? languageController.isToggled.value
//                                   ? packageData!['package_name_in_local_language']
//                                       .trim()
...
//                                 final String serviceLeadId =
//                                     service['lead_id'] ?? widget.lead_id;
//                                 final String serviceTblName = _getTblName(
//                                   service['service_name'] ?? 'Unknown Service',
//                                 );
//                                 final order = orderController.allOrders
//                                     .firstWhere(
//                                       (o) => o.id == serviceLeadId,
//                                       orElse:
//                                           () =>
//                                               orderController
//                                                       .allOrders
...
//                                       );
//                                       log(
//                                         'Order ID from Controller: ${order.id}',
//                                       );
//                                       if (service['form_status'] == 1) {
//                                         log(
//                                           "Navigating to OrderpackageDetail: form_status = ${service['form_status']} lead_status = ${service['lead_status']}",
//                                         );
...
//                   //               );
//                   //               final order =
//                   //                   orderController.allOrders.isNotEmpty
//                   //                       ? orderController.allOrders.firstWhere(
//                   //                         (o) => o.id == serviceLeadId,
//                   //                         orElse:
//                   //                             () => orderController.allOrders
//                   //                                 .firstWhere(
...
//                   //                       : {
//                   //                         "text": "Unknown Status",
//                   //                       }; // Default value when order is null
...
import 'dart:developer';
import 'dart:io';
import 'package:bhulexapp/My_package/order_package_details.dart';
...
import 'package:bhulexapp/controller/order/my_order_controller.dart';
